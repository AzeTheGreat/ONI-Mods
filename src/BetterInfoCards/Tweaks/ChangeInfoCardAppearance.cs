...
namespace BetterInfoCards
{
    ...
    class FontSizeDecrease_Patch
    {
        ...
        static void Prefix(TextStyleSetting style) => style.fontSize -= fontSizeDecrease;
        static void Postfix(TextStyleSetting style) => style.fontSize += fontSizeDecrease;
    }
    ...
    class NewLineHeight_Patch
    {
        ...
        static bool Prepare() => Options.Opts.Compactness != Options.CompactMode.Default;
        static void Prefix(ref int min_height) => min_height = minHeight;
    }
    ...
    class Opacity_Patch
    {
        ...
        static void Prefix(HoverTextDrawer.Skin skin)
        {
