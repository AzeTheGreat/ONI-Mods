...
namespace BetterLogicOverlay
{
    public class MYSTRINGS : RegisterStrings
    {
        ...
        public class ABBREVIATIONS
        {
            ...
            public static LocString AluminumGas = Aluminum;
            public static LocString AluminumOre = Aluminum;
            public static LocString MoltenAluminum = Aluminum;
            ...
            public static LocString CarbonGas = Carbon;
            public static LocString MoltenCarbon = Carbon;

            public static LocString CarbonDioxide = "CO<sub>2</sub>";
            public static LocString LiquidCarbonDioxide = CarbonDioxide;
            public static LocString SolidCarbonDioxide = CarbonDioxide;

            public static LocString Ceramic = string.Empty;

            public static LocString Chlorine = "Cl";
            public static LocString ChlorineGas = Chlorine;
            public static LocString SolidChlorine = Chlorine;
            ...
            public static LocString MoltenCopper = Copper;
            public static LocString CopperGas = Copper;

            public static LocString CrudeOil = "C-Oil";
            public static LocString SolidCrudeOil = CrudeOil;
            ...
            public static LocString EthanolGas = Ethanol;
            public static LocString SolidEthanol = Ethanol;
            ...
            public static LocString MoltenGlass = Glass;

            public static LocString Gold = "Au";
            public static LocString GoldGas = Gold;
            public static LocString MoltenGold = Gold;
            ...
            public static LocString LiquidHydrogen = Hydrogen;
            public static LocString SolidHydrogen = Hydrogen;

            public static LocString IgneousRock = string.Empty;

            public static LocString Iron = "Fe";
            public static LocString IronGas = Iron;
            public static LocString MoltenIron = Iron;
            ...
            public static LocString LeadGas = Lead;
            public static LocString MoltenLead = Lead;
            ...
            public static LocString LiquidMethane = Methane;
            public static LocString SolidMethane = Methane;

            public static LocString Naphtha = "Nap";
            public static LocString SolidNaphtha = "Nap";

            public static LocString Obsidian = string.Empty;

            public static LocString Oxygen = "O<sub>2</sub>";
            public static LocString LiquidOxygen = "O";
            public static LocString SolidOxygen = LiquidOxygen;
            ...
            public static LocString SolidPetroleum = Petroleum;

            public static LocString Phosphorus = "P";
            public static LocString LiquidPhosphorus = Phosphorus;
            public static LocString PhosphorusGas = Phosphorus;
            ...
            public static LocString LiquidPropane = Propane;
            public static LocString SolidPropane = Propane;
            ...
            public static LocString MoltenSalt = Salt;
            public static LocString SaltGas = Salt;
            ...
            public static LocString MoltenSteel = Steel;
            public static LocString SteelGas = Steel;

            public static LocString Sulfur = "S";
            public static LocString SulfurGas = Sulfur;
            public static LocString LiquidSulfur = Sulfur;

            public static LocString SuperCoolant = "S-Cool";
            public static LocString SolidSuperCoolant = SuperCoolant;
            public static LocString SuperCoolantGas = SuperCoolant;
            ...
            public static LocString MoltenTungsten = Tungsten;
            public static LocString TungstenGas = Tungsten;

            public static LocString Niobium = "Nb";
            public static LocString NiobiumGas = Niobium;
            public static LocString MoltenNiobium = Niobium;
            ...
            public static LocString SolidViscoGel = ViscoGel;
